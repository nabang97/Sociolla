...
// ------------------- INPUT DATA ------------------//
  ...
  function showPhotoOrder($ordernum,$size,$shade,$weight,$color){
    ...
    WHERE dv.id_detail_product = '".$ordernum."' AND dv.size_id = ".$size." AND dv.shade_id = ".$shade." AND dv.weight_id = ".$weight." AND dv.color_id = ".$color."");
    $stmt->execute();
