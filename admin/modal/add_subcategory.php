    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="forms-sample">
          ...
          <div class="form-group">
            <label for="exampleInputUsername1">Subategory Code</label>
            <input type="text" class="form-control" placeholder="Input kode kategori" id="id" required>
          </div>
          <div class="form-group">
        ...
        <div class="float-right">
          <button type="submit" class="btn btn-gradient-primary mr-2" id="btn-add-subcategory" onclick="insertProductSubCategory()">Add</button>
